...
function snp_setup_admin()
{
    ...
    elseif (snp_get_option('ml_manager') == 'mailster')
    {
        $ml_fields[] = array(
        'id'         => 'ml_mm_list',
        'type'       => 'mailster_lists',
	...
	elseif (snp_get_option('ml_manager') == 'freshmail')
	{
        ...
        elseif (snp_get_option('ml_manager') == 'mailrelay')
	{
	    $ml_fields[] = array(
		'id'		 => 'ml_mailrelay_list',
		'type'		 => 'mailrelay_lists',
	...
	elseif (snp_get_option('ml_manager') == 'sendreach')
	{
	    $ml_fields[] = array(
		'id'		 => 'ml_sendreach_list',
		'type'		 => 'sendreach_lists',
    ...
    elseif (snp_get_option('ml_manager') == 'hubspot')
    {
        $ml_fields[] = array(
        'id'         => 'ml_hubspot_list',
        'type'       => 'hubspot_lists',
    ...
    elseif (snp_get_option('ml_manager') == 'convertkit')
    {
        $ml_fields[] = array(
        'id'         => 'ml_convertkit_list',
        'type'       => 'convertkit_lists',
    ...
    elseif (snp_get_option('ml_manager') == 'enewsletter')
    {
        $ml_fields[] = array(
        'id'         => 'ml_enewsletter_list',
        'type'       => 'enewsletter_lists',
