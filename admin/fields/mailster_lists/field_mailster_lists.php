<?php
class SNP_NHP_Options_mailster_lists extends SNP_NHP_Options
{
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_mailster_lists();
	...
	{
		wp_enqueue_script(
				'nhp-opts-field-mailster_lists-js', SNP_NHP_OPTIONS_URL . 'fields/mailster_lists/field_mailster_lists.js', array('jquery'), time(), true
		);
	}
}