	...
	function render()
	{
		...
		<div id="builder-tpl" style="display: none;">
		    <?php
                    ...
                    $this->element_tpl('text', array('preset' => 1, 'width' => 200, 'height' => 75, 'content' => ''));
                    echo '</div>';
                    echo '<div class="builder-tpl-lib-group">';
                    $this->element_tpl('pointlist', array('preset' => 1, 'width' => 200, 'height' => 75, 'options' => array()));
                    echo '</div>';
                    echo '<div class="builder-tpl-lib-group">';
                    $this->element_tpl('img', array('preset' => 1, 'textlabel' => 1, 'width' => '165' ,'height' => '100', 'img' => SNP_URL.'admin/img/img-placeholder.png'));
                    echo '</div>';
                    echo '<div class="builder-tpl-lib-group">';
                    $this->element_tpl('video', array('preset' => 1, 'textlabel' => 1, 'width' => '165' ,'height' => '100'));
                    echo '</div>';
                    echo '<div class="builder-tpl-lib-group">';
		    ...
		    $this->element_tpl('input',array('preset' => 1, 'width' => '200' ,'height' => '50', 'icon' => '', 'border-style' => 'solid', 'border-color' => '#999999', 'border-width' => '2'));
                    echo '</div>';
                    echo '<div class="builder-tpl-lib-group">';
                    $this->element_tpl('map', array('preset' => 1, 'textlabel' => 1, 'width' => '165' ,'height' => '100'));
                    echo '</div>';
                    echo '<div class="builder-tpl-lib-group">';
		    ...
		    $this->element_tpl('hr',array('preset' => 1, 'width' => '200' ,'height' => '3')); 
                    echo '</div>';
                    echo '<div class="builder-tpl-lib-group">';
            $this->element_tpl('html',array('preset' => 1, 'width' => '200', 'height' => '100', 'icon' => '', 'border-style' => 'solid', 'border-color' => '#999999', 'border-width' => '2'));
                    echo '</div>';
         ...
         ?>
			...
			<div class="bld-form-group">
                        ...
                        <div class="bld-form-group">
                            ...
                            <div class="bld-inputs">
                                            ...
                                            ) as $s => $v)
                                {
                                    ...
                                    if($s=='link')
                                    {
                                        echo '<input type="text" '.(isset($input_disabled)?$input_disabled:'').' class="bld-editbox-medium" name="snp_bld['.$RAND.'][action-link]" value="'.(isset($args['action-link'])?$args['action-link']:'').'"/> <input type="checkbox" '.(isset($input_disabled)?$input_disabled:'').' name="snp_bld['.$RAND.'][open_type]" value="blank" '.((isset($args['open_type']) && $args['open_type']=='blank') ? 'checked' : '').'> Open in new window';
                                    }
                                    if ($s == 'select_link') {
                                        ?>
                                        <br />
                                        ...
                                        <div class="bld-form-group bld-form-group-select-link-options">
                                            <div class="bld-inputs">
			                                    ...
			                                    if (!isset($args['select_link_options']) || count($args['select_link_options'])==0) {
				                                    $args['select_link_options'] = array( '' );
			                                    }

			                                    $i = 0;
			                                    foreach($args['select_link_options'] as $option) {
				                                    echo '<div class="bld-editbox-select-link-options-option">
                                                        Search for value: <input type="text" ' . $input_disabled . ' name="snp_bld[' . $RAND . '][select_link_options]['.$i.'][name]" value="' . $option['name'] . '"/><br />
                                                        Redirect to: <input type="text" ' . $input_disabled . ' name="snp_bld[' . $RAND . '][select_link_options]['.$i.'][url]" value="' . $option['url'] . '"/><a href="#" class="bld-editbox-select-link-options-delete button">Delete</a>
                                                    </div>';
                        ...
                        <div class="bld-form-group">
                            ...
                            <div class="bld-inputs">
                                ...
                                echo    '<select name="snp_bld['.$RAND.'][map-type]">
                                            <option value="ROADMAP" '.($args['map-type']=='ROADMAP'?'selected':'') .'>Roadmap</option>
                                            <option value="SATELLITE" '.($args['map-type']=='SATELLITE'?'selected':'') .'>Satellite</option>
                                            <option value="HYBRID" '.($args['map-type']=='HYBRID'?'selected':'') .'>Hybrid</option>
                                            <option value="TERRAIN" '.($args['map-type']=='TERRAIN'?'selected':'') .'>Terrain</option>
                                        </select>';
                                ?>
                            </div>
                        </div>
		    		...
		    		<div class="bld-form-group">
		    			...
		    			<div class="bld-inputs">
		    				<?php echo '<textarea name="snp_bld['.$RAND.'][custom_html]" style="height: 300px;">'.$args['custom_html'].'</textarea>'; ?>
		    			</div>
		    		</div>
		    		<?php endif; ?>
    		    </div>
	...
	function element_tpl($type, $args = array())
	{
		...
		elseif($type=='hr')
		{
		    echo '<hr '.($css ? 'style="'.$css.'"' :'').'  '.$data.'  class="bld-el '.$css_class.'"/>';
                ...
                if(in_array($type,array('input','textarea','select','html')))
                {
                  $icon_css_class = '';
                  $icon_css = '';
