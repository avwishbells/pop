...
class SNP_NHP_Options_enewsletter_lists extends SNP_NHP_Options
{
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_enewsletter_lists();
		...
		{
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button enewsletter_lists_gl" name="" value="Grab Lists" />';
		}
	...
	{
		wp_enqueue_script(
				'nhp-opts-field-enewsletter_lists-js', SNP_NHP_OPTIONS_URL . 'fields/enewsletter_lists/field_enewsletter_lists.js', array('jquery', 'farbtastic'), time(), true
		);
	}
}