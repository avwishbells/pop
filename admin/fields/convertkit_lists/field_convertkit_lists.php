...
class SNP_NHP_Options_convertkit_lists extends SNP_NHP_Options
{
	...
	function render()
	{
		...
		$this->field['options']=snp_ml_get_convertkit_lists();
		...
		{
		    echo '<input type="button" rel-id="' . $this->field['id'] . '" class="button convertkit_lists_gl" name="" value="Grab Lists" />';
		}
	...
	{
		wp_enqueue_script(
		    'nhp-opts-field-convertkit_lists-js', SNP_NHP_OPTIONS_URL . 'fields/convertkit_lists/field_convertkit_lists.js', array('jquery', 'farbtastic'), time(), true
		);
	}
}