...
//function	
	...
	{
	    global $post;
	    $ex = array('sendlane_lists', 'customerio_lists', 'mailrelay_lists', 'mailup_lists', 'ontraport_lists', 'newsletter_lists', 'sendreach_lists', 'sendpulse_lists', 'salesmanago_lists', 'mailjet_lists', 'benchmarkemail_lists', 'sendgrid_lists', 'agilecrm_lists', 'elasticemail_lists', 'salesautopilot_lists' ,'myemma_lists','mailerlite_lists', 'activecampaign_fields','rocketresponder_lists', 'freshmail_lists', 'infusionsoft_lists','icontact_lists','mailchimp_lists','sendinblue_lists','sendpress_lists','egoi_lists','getresponse_lists','wysija_lists','campaignmonitor_lists','aweber_lists','mymail_lists','mailster_lists','madmimi_lists','constantcontact_lists','aweber_auth','hubspot_lists','convertkit_lists','enewsletter_lists');
