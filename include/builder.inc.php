...
function snp_builder_create_element($type, $step_index, $el_index, $args)
{
    ...
    if(isset($args['action']) && $args['action']!='')
    {
        ...
        elseif($args['action']=='link')
        {
            ...
            if ($args['open_type'] == 'blank') {
                $data .= ' onclick="window.open(\'' . $args['action-link'] . '\', \'_blank\');"';
            } else {
	        ...
	        if ($args['select_link_open_type'] == 'blank') {
		        $data .= ' onclick="snp_open_select_link(this, true);"';
	        } else {
		        $data .= ' onclick="snp_open_select_link(this, false);"';
	        }
        }
    ...
    elseif($type=='img')
    {
        $return .=  '<img class="bld-el '.$css_class.'" '.$data.' src="'.(isset($args['img']) && $args['img']!='' ? $args['img'] : SNP_URL . '/admin/img/img-placeholder.png').'" alt="" />';
    ...
    elseif($type=='select')
    {
        ...
        $return .= '<div class="bld-table-cont">';
        $return .= '<select '.$data.' class="snp-el-bld-select bld-el '.$css_class.'">';
        if ($args['placeholder'])
        {
    ...
    elseif($type=='html') {
    	$return .= '<div class="bld-el '.$css_class.'" '.$data.'>'.(isset($args['custom_html']) ? $args['custom_html'] : '').'</div>';
    }
    $return .= '</div>';
    return $return;
}
